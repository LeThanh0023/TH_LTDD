...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fruitArrayAdapter = new FruitArrayAdapter(getApplicationContext(), R.layout.row_activity);
        ...
        for(String[] fruitData:fruitList ) {
            ...
            int fruitImgResId = getResources().getIdentifier(fruitImg, "drawable", "com.example.fruitlist");
